...
.q-pa-md
    q-card.absolute-center.q-pa-sm(style="width: 40%")
      q-card
        .text-h5.text-center.login-title.q-my-md Crear Productos
...
const get = async () => {
  ...
  fields.value.provider_name = product.provider_name
  fields.value.provider_phone = product.provider_phone
